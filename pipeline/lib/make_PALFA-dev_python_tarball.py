...
pipeline_dir = '/home/pscholz/pipeline-dev/pipeline2.0/' 

# binaries to put in tarball bin dir (if folder will copy contents of it)
bins = [ os.path.join(pipeline_dir,'bin/search.py'),
...
site_packages_contents = [ os.path.join(pipeline_dir,'lib/python/'),
...
new_tarball = "/sb/project/bgf-180-aa/python_tarballs/python-2.6.8-packages-PALFA-dev.tar.gz"
